  ...
  return (
    <motion.div className="desktop-detail-view" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -5 }} transition={{ duration: 0.25 }}>
      ...
      <div className="desktop-detail-quick-links">
        ...
        <a href="https://drive.google.com/drive/folders/1NILiLOGCmGQi88opwFHKlOdwTx4rjTDo?usp=drive_link" target="_blank" rel="noreferrer">Resume <ExternalLink size={12} /></a>
      </div>
    </motion.div>
  );
}
  ...
  return (
    <motion.div className="desktop-detail-view" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -5 }} transition={{ duration: 0.25 }}>
      ...
      {sectionId === 'about' ? (
        <>
          <PanelLabel>AT A GLANCE</PanelLabel>
           <div className="desktop-info-stats"><span><b>6+</b>Projects</span><span><b>3</b>Semesters</span><span><b>4+</b>Certificates</span></div>
        </>
      ) : null}
      {sectionId === 'skills' ? (
        <>
      ...
      {sectionId === 'experience' ? (
        <>
          <PanelLabel>TIMELINE</PanelLabel>
           <div className="desktop-timeline-info"><span><b>Bluestock Fintech</b>Data Analyst Intern · Remote</span><span><b>Deloitte Australia</b>Data Analytics · Forage</span><span><b>Tata iQ</b>GenAI Data Analytics · Forage</span></div>
        </>
      ) : null}
      {sectionId === 'certificates' ? (
        <>
          <PanelLabel>CERTIFICATES</PanelLabel>
           <div className="desktop-cert-mini-list"><span>Data Analyst Intern Certificate <small>Bluestock Fintech · Startup India</small></span><span>Anthropic MCP <small>Anthropic</small></span><span>Deloitte Data Analytics <small>Forage</small></span><span>Tata iQ GenAI Analytics <small>Forage</small></span></div>
          <div className="desktop-detail-quick-links"><a href="https://www.linkedin.com/in/pondara-akhil-behara-016126381" target="_blank" rel="noreferrer">LinkedIn <ExternalLink size={12} /></a><a href="https://drive.google.com/drive/folders/1NILiLOGCmGQi88opwFHKlOdwTx4rjTDo?usp=drive_link" target="_blank" rel="noreferrer">Drive <ExternalLink size={12} /></a></div>
        </>
      ) : null}
    </motion.div>
  );
